...
\providecommand{\myTitle}{PARCIALITO}
\providecommand{\mySubtitle}{Entrenamiento no supervisado}

\providecommand{\mySubject}{Procesamiento del habla (86.53)}
\providecommand{\myKeywords}{UBA, Ingeniería, kmeans, ml, likelihood}
